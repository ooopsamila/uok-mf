    ...
    <div class="row">
        <div class="box">
            <div class="col-lg-12 text-center">
                <a class = "navbar-nav" href="orderTable.html">Book a table</a>
                <div id="carousel-example-generic" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="img-responsive img-full" src="themes/orange/images/table-1.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive img-full" src="themes/orange/images/table-2.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive img-full" src="themes/orange/images/table-3.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive img-full" src="themes/orange/images/table-4.jpg" alt="">
                        </div>
                    </div>
